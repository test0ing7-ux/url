                    ...
                    if (isText) {
                        ...
                        if (isHtml) {
                            ...
                            const locSpoof = `<script>(function(){
                                ...
                                try{
                                    window.api={
                                        _invoke: function(action, payload) {
                                            if (action === '_encrypt-payload' || action === '_encrypt-payload-v2') return Promise.resolve(payload);
                                            if (action === '_decode-payload') return Promise.resolve(payload);
                                            return Promise.resolve();
                                        },
                                        _sendToMain: function(){},
                                        _receiveFromMain: function(){},
